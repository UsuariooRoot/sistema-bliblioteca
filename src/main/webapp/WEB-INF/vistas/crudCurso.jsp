		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_codigo" name="codigo" placeholder="Ingrese el Codigo" type="text" maxlength="5"/>
		                                        </div>
		                                    </div>
		                                     <div class="form-group">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_estado" name="estado" placeholder="Ingrese el número de estado" type="text" maxlength="8"/>
		                                        </div>
		                                    </div>
		                                
		                                    </div>    
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_sistemaevaluacion">Sistema de Evaluacion</label>
		                                        <div class="col-lg-5">
													<select id="id_reg_sistemaevaluacion" name="sistemaevaluacion.idSistemaEvaluacion" class='form-control'>
		                                ...
		                                <div class="panel-body">
		                                    <div class="form-group">
		                                      ...
		                                      <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_codigo" name="codigo" placeholder="Ingrese el codigo" type="text" maxlength="5"/>
		                                        </div>
		                                    </div>
		                                     <div class="form-group">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_estado" name="estado" placeholder="Ingrese el Estado" type="text" maxlength="8"/>
		                                        </div>
		                                    </div>		   
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_sistemaevaluacion">Sistema de Evaluacion</label>
		                                        <div class="col-lg-5">
													<select id="id_act_sistemaevaluacion" name="sistemaevaluacion.idSistemaEvaluacion" class='form-control'>
							                            	<option value=" ">[Seleccione]</option>    
							                         </select>
		                                        </div>
		                                    </div>
...
$.getJSON("cargasistemaevaluacion", {}, function(data, q,t){
	...
	$.each(data, function(index,item){
		$("#id_reg_sistemaevaluacion").append("<option value="+item.idSistemaEvaluacion +">"+ item.nombre +"</option>");
		$("#id_act_sistemaevaluacion").append("<option value="+item.idSistemaEvaluacion +">"+ item.nombre +"</option>");
	});
...
function editar(id,codigo,nombre,estado,idSistemaEvaluacion){	
	...
	$('select[id=id_act_sistemaevaluacion]').val(idSistemaEvaluacion);
...
<script type="text/javascript">
	$('#id_form_registra').bootstrapValidator({
        ...
        fields: {
            ...
            "sistameaevalucion.idSistemaEvaluacion": {
        		selector : '#id_reg_sistemaevaluacion',
                validators: {
                	notEmpty: {
                        message: 'El Sistema de Evaluación es un campo obligatorio'
                    },
                }
            },
	...
	$('#id_form_actualiza').bootstrapValidator({
        ...
        fields: {	
            ...
            "sistemaevaluacion.idSistemaEvaluacion": {
        		selector : '#id_act_sistemaevaluacion',
                validators: {
                	notEmpty: {
