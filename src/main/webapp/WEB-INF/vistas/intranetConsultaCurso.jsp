			...
			<div class="col-md-3">		
				<div class="form-group">
					<select id="id_sistemaevaluacion" name="curso.sistemaevaluacion.idSistemaEvaluacion" class='form-control'>
						<option value="0">[Seleccione Sistema de Evaluacion]</option>    
...
<script type="text/javascript">
	$("#id_sistemaevaluacion").change(function(){
		 	...
		 	$.getJSON("consultarCursos", {"parametro":var_sistemaevaluacion}, function(data){
				$.each(data, function(index,item){
					$("#id_table").append("<tr><td>"+ item.idCurso +"</td><td>"+ item.codigo +"</td><td>"+ item.nombre +"</td><td>"+ item.estado +"</td><td>"+ item.sistemaevaluacion.nombre +"</td><td>");
				});
			});
	...
	$.getJSON("listaTotalSistemas",{}, function(data){
